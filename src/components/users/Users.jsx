...
export default function EnhancedTable() {
    ...
    return (
        <Box sx={{width: '100%',}}>
            <Paper sx={{maxWidth: 1000, mb: 2, margin: '0 auto'}}>
                ...
                <TablePagination
                    ...
                    labelDisplayedRows={function defaultLabelDisplayedRows({ from, to, count }) { return `${from}–${to} из ${count !== -1 ? count : `more than ${to}`}`; }}
                />
            </Paper>
        </Box>
    );
